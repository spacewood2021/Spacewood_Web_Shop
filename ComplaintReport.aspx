<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ComplaintReport.aspx.cs" Inherits="WebShop.ComplaintReport" %>
        ...
        function Bind_ComplaintDetails() {
            ...
            if (t_codtF != "" && t_codtT != "") {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "ComplaintReport.aspx/GetComplaintDetails",
                    data: '{t_codtF:"' + t_codtF + '",t_codtT:"' + t_codtT + '"}',
                    //t_usid:"' + t_crus + '",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ct1" runat="server">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Datewise Complaint report</h1>
