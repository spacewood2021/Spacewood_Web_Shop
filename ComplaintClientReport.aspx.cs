...
namespace WebShop
{
  public partial class ComplaintClientReport : System.Web.UI.Page
  {
    ...
    public static List<ttdtst141100_142_class> GetComplaintDetails(string t_prbp,string t_codtF,string t_codtT)
    {
      //string t_usid,
      string constr = ConfigurationManager.ConnectionStrings["SqlConn"].ConnectionString;
      try
      {
        List<ttdtst141100_142_class> Prdlst = new List<ttdtst141100_142_class>();
        ...
        using (SqlConnection con = new SqlConnection(constr))
        {
          ...
          comm.Parameters.AddWithValue("@t_flag", "C");
          ...
          while (sdr.Read())
          {
            Prdlst.Add(new ttdtst141100_142_class
            {
  ...
  public class ttdtst141100_142_class
  {
